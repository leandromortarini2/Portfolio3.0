...
const Experience: React.FC = () => {
  return (
    ...
    >
      <h1 className="text-azul text-3xl md:text-4xl lg:text-[40px] xl:text-[60px] font-bold mt-14 md:mt-10  lg:mb-5 xl:mb-10">
        Experiencia Laboral
      </h1>
      <VerticalTimeline lineColor="#0c94ca">
        ...
        >
          <h3 className="text-sky-500">
            Desarrollador Front-End en Inflatrack
          </h3>
        ...
        <VerticalTimelineElement
          className="vertical-timeline-element--education  text-azul "
          iconStyle={{ background: "#0ea5e9", color: "#fff" }}
          icon={<MdComputer />}
          date="Junio 2024 - Julio 2024"
        >
          <h3 className="text-sky-500 font-bold"> Freelance Front-End</h3>
          <p className="text-azul">
        ...
        >
          <h3 className="text-sky-500">Oficial de Policia</h3>
          <p className="text-azul">
